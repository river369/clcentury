...
<head>
    ...
    <script src="http://clcentury.oss-cn-beijing.aliyuncs.com/resource/js/jquery/jquery-1.11.1.min.js"></script>
    <script src="http://clcentury.oss-cn-beijing.aliyuncs.com/resource/js/jquery/jquery.mobile-1.4.5.min.js"></script>
    <script src="http://clcentury.oss-cn-beijing.aliyuncs.com/resource/js/rater/rater.min.js"></script>
    <script src="http://clcentury.oss-cn-beijing.aliyuncs.com/resource/js/camera/jquery.min.js"></script>
    <script src="http://clcentury.oss-cn-beijing.aliyuncs.com/resource/js/camera/jquery.easing.1.3.js"></script>
    <script src="http://clcentury.oss-cn-beijing.aliyuncs.com/resource/js/camera/camera.min.js"></script>
    <script src="http://clcentury.oss-cn-beijing.aliyuncs.com/resource/js/camera/jquery.mobile.customized.min.js"></script>
    <script src="http://clcentury.oss-cn-beijing.aliyuncs.com/resource/js/business/discover.js"></script>

    <link rel="stylesheet" href="http://clcentury.oss-cn-beijing.aliyuncs.com/resource/style/jquery/jquery.mobile-1.4.5.min.css" />
    <link rel="stylesheet" href="http://clcentury.oss-cn-beijing.aliyuncs.com/resource/style/themes/my-theme.min.css" />
    <link rel="stylesheet" href="http://clcentury.oss-cn-beijing.aliyuncs.com/resource/style/camera/camera.css" type="text/css" media="all">
    <link rel="stylesheet" href="http://clcentury.oss-cn-beijing.aliyuncs.com/resource/style/business/discover.css" type="text/css" media="all">
    ...
    <script>
        $(document).ready(function(){
            ...
            $("img").error(function () {
                $(this).attr("src", "http://clcentury.oss-cn-beijing.aliyuncs.com/resource/images/head_default.jpg");
            });
        });
