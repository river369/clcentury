...
<div data-url="panel-fixed-page1" data-role="page" class="jqm-demos" id="panel-fixed-page1" data-title="易知海外">
    ...
    <div role="main" class="ui-content jqm-content jqm-fullwidth">
        <div data-role="navbar">
            <ul>
                <li><a href="../../../Controller/AuthUserDispatcher.php?c=querysellerorder&sellerid=<?php echo $sellerid;?>&condition=0" <?php echo $ordersCondition == 0 ? "class='ui-btn-active'" : ''; ?> >待接收</a></li>
                <li><a href="../../../Controller/AuthUserDispatcher.php?c=querysellerorder&sellerid=<?php echo $sellerid;?>&condition=2" <?php echo $ordersCondition == 2 ? "class='ui-btn-active'" : '' ?>>已接收</a></li>
                <li><a href="../../../Controller/AuthUserDispatcher.php?c=querysellerorder&sellerid=<?php echo $sellerid;?>&condition=4" <?php echo $ordersCondition == 4 ? "class='ui-btn-active'" : '' ?>>已完成</a></li>
                <li><a href="../../../Controller/AuthUserDispatcher.php?c=querysellerorder&sellerid=<?php echo $sellerid;?>&condition=8" <?php echo $ordersCondition == 8 ? "class='ui-btn-active'" : '' ?>>已到账</a></li>
            </ul>
        </div><!-- /navbar -->
        <?php
        ...
        <ul data-role="listview" data-inset="true">
            ...
            <?php } ?>
            <?php if ($ordersCondition == 2) {?>
                <li>
                    <div class="ui-grid-a">
                        <div class="ui-block-a"><a href="#rejectDialog" data-rel="popup" class="ui-shadow ui-btn ui-corner-all ui-mini" onclick="rejectPopup('<?php echo $orderid; ?>')">取消订单</a></div>
                        <div class="ui-block-b"><a href="#acceptDialog" data-rel="popup" class="ui-shadow ui-btn ui-corner-all ui-mini" onclick="acceptPopup('<?php echo $orderid; ?>')">完成定单</a></div>
                    </div>
                </li>
            <?php } ?>
        </ul>
        ...
        <div data-role="popup" id="acceptDialog" data-overlay-theme="b" data-theme="b" style="max-width:400px;">
        ...
        <div data-role="popup" id="rejectDialog" data-overlay-theme="b" data-theme="b" style="max-width:400px;">
            <div data-role="header" data-theme="a">
                <h1>拒绝订单</h1>
            </div>
            <div role="main" class="ui-content">
