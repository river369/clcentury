...
switch ($parameter) {
    case 'getServices':
        //    http://www.clcentury.com/weiphp/Addons/OverSea/test/testApi.php?p=getServices
        Test('getServices', array('serviceArea'=>'地球', 'serviceType'=>'1', 'pageIndex'=>'0'));
        break;
    case 'getServicePictures':
        //    http://www.clcentury.com/weiphp/Addons/OverSea/test/testApi.php?p=getServicePictures
        Test('getServicePictures', array('sellerId'=>'585243db3d418420', 'serviceId'=>'5854de4c627c1448'));
        break;
    case 'getServiceInfoById':
        Test('getServiceInfoById', array('serviceId'=>'5854de4c627c1448'));
        break;
    case 'getAggregatedServiceDetails':
    ...
    case 'signIn':
        ...
        break;
    case 'createOrUpdatePublishingService':
        Test('createOrUpdatePublishingService', array('sellerId'=>'57790fb728713607', 'serviceId'=>''));
        break;
}
